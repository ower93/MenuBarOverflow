...
- The dropdown identifies each menu extra with its owning application's icon.
...
The opt-in design for selecting which icons should live in Menu Bar Overflow,
including drag ordering and recovery requirements, is documented in
[`docs/MANAGED_ICONS_PLAN.md`](docs/MANAGED_ICONS_PLAN.md).

## Permissions

- Accessibility is required so the app can enumerate and press menu extras.
- Screen Recording is not used or requested.
